export const Congrats = () => {
  return (
    <>
      ...
      <p className='text-[19px] text-center mb-20 text-Neutral-300'>We've emailed your ticket to <span className='text-Orange-500'>jonatan@gmail.com</span> and will send updates in the run up to the event.</p>
    </>
  )
}
